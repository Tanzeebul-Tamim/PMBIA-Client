    ...
    >
      ...
      <div className="text-xl flex flex-col gap-10 text-center">
        ...
        <p>
          ...
          skills, we welcome you to join our community. Together, let&apos;s explore
          the trails, embrace the challenges, and experience the thrill of
          mountain biking. Get ready to discover the freedom, adrenaline, and

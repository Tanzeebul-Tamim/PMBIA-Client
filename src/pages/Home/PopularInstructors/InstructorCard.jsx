...
const InstructorCard = () => {
  return (
    <div className="card group relative description rounded-2xl card-compact w-96 bg-base-200 mr-2 ml-2 shadow-xl">
      ...
      <img
        className="group-hover:scale-110 duration-200 lg:w-[145px] w-[85px] lg:h-[145px] h-[85px] absolute right-3 bottom-[25%] lg:bottom-[20%] rounded-full border-zinc-400 border-[2px] lg:border-[4px]"
